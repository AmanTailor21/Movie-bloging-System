    ...
    <div class="row">
        ...
        foreach ($a as $rs) { ?>
            <div class="col-sm-2 mt-4">
                <div class="card">
                    <img class="card-img-top" height="350px" src="<?php echo "image/" . $rs[4]; ?>">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $rs[1]; ?></h5>
                        <p class="card-text"><?php echo $rs[2]; ?></p>
                        <p class="card-text"><small class="text-muted"><a href="login.php">Read More... </a></small></p>
                    </div>
                </div>
            </div>
            <?php
